...
if __name__ == "__main__":
    ...
    from models.resnet import resnet34, resnet152

    model = resnet152(3, num_classes=6)
    aa = ['resnet152_test_resnet152_0305_2022Mar07_00.33']
    for iii in aa:
        os.makedirs(f'./result/{iii}',exist_ok=True)
        state = torch.load(f"../checkpoint/{iii}")
        ...
        for image_path in natsorted(test_img):
            ...
            cv2.imwrite(
                "./result/{}/{}".format(iii, image_name), np.uint8(255 * cam)
            )
