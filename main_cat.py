...
def get_dataset(configs):
    ...
    from classification.catemotion import catnet
    # todo: add transform
    train_set = catnet("train", configs)
    val_set = catnet("val", configs)
    test_set = catnet("test", configs)
    # train_set.__getitem__(500)
    print('set')
    return train_set, val_set, test_set

if __name__ == "__main__":
    main("./configs/cat_config.json")
