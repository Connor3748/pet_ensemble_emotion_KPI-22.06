...
ann_file_train = '../data/posec3d/ntu60_xsub_train.pkl'# 'data/posec3d/gym_train.pkl'
ann_file_val = '../data/posec3d/ntu60_xsub_val.pkl'# 'data/posec3d/gym_val.pkl'
...
data = dict(
    ...
    train=dict(type=dataset_type,ann_file=ann_file_train,data_prefix='',pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
